...
def make_exe(dist):
    ...
    exe.add_python_resources(exe.read_package_root(
       path="/Users/rickforce/PycharmProjects/vojp",
       packages=["vojp", "database"],
    ))

    # Discover Python files from a virtualenv and add them to our embedded
    # context.
    # exe.add_python_resources(exe.read_virtualenv(path="/Users/rickforce/PycharmProjects/vojp/venv"))
